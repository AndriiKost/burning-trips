...
func TestFindUser(t *testing.T) {
	...
	foundUser, err := userInstance.Find(server.DB, user.ID)
	if err != nil {
...
func TestUpdateUser(t *testing.T) {
	...
	updatedUser, err := userUpdate.Update(server.DB, user.ID)
	if err != nil {
...
func TestDeleteUser(t *testing.T) {
	...
	isDeleted, err := userInstance.Delete(server.DB, user.ID)
	if err != nil {
		t.Errorf("this is the error updating the user: %v\n", err)
		return
	}
