import { IApiResponse, IApiRequestOptions } from 'http';
...
export default class BaseHttpService {
    ...
    private async _handleBadResponse(request: ApiRequestInit, response: Response, supressErrors: boolean): Promise<IApiResponse<T>> {
